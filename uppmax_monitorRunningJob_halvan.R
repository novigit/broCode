...
columns<-c("Time","Seconds","GB_LIMIT","GB_USED","GB_SWAP_USED","CPU1","CPU2","CPU3","CPU4","CPU5","CPU6","CPU7","CPU8","CPU9","CPU10","CPU11","CPU12","CPU13","CPU14","CPU15","CPU16","CPU17","CPU18","CPU19","CPU20","CPU21","CPU22","CPU23","CPU24","CPU25","CPU26","CPU27","CPU28","CPU29","CPU30","CPU31","CPU32")
log=paste('/sw/share/slurm/halvan/uppmax_jobstats/', node, '/', jobid, sep="")
...
# get cpu usage
totalcpu<-rowSums(df[,c(6:37)])

# get memory usage
mem<-df$GB_USED

# plot into output
png(filename=output, width=960, height=960, units="px")
